  ...
  return (
    <div className="relative w-full h-full group">
      ...
      <div className="relative h-full p-8 flex flex-col justify-end z-10">
        <div className={`transition-all duration-500 transform ${isHovered ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-100'} md:translate-y-4 md:opacity-100`}>
          ...
          <div className={`space-y-2 overflow-hidden transition-all duration-500 max-h-40 opacity-100 md:max-h-0 md:opacity-0 ${isHovered ? 'md:max-h-40 md:opacity-100' : ''}`}>
